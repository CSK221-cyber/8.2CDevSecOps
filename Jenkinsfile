            ...
            steps {
                withCredentials([string(credentialsId: 'SONAR_TOKEN', variable: 'SONAR_TOKEN')]) {
                    bat '''
                        ...
                        %JAVA_17_PATH% -jar %SONAR_SCANNER_FOLDER%\\sonar-scanner-4.8.0.2856-windows\\lib\\sonar-scanner-cli-4.8.0.2856.jar -D"sonar.login=%SONAR_TOKEN%" -D"sonar.projectBaseDir=nodejs-goof"
                    '''
                }
            }
        }
