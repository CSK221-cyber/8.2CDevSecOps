pipeline {
  ...
  stages {
    ...
    stage('SonarCloud Analysis') {
      steps {
        bat '''
          if exist sonar-scanner-4.8.0.2856-windows (
            rmdir /s /q sonar-scanner-4.8.0.2856-windows
          )
          ...
          powershell -Command "Expand-Archive -Path sonar-scanner-cli.zip -DestinationPath . -Force"
